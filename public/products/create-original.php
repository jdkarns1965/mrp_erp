        ...
        <form method="POST" action="">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <span class="tooltip">Unique product identifier (e.g., PROD001)</span>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <span class="tooltip">How the product is measured (pieces, kg, etc.)</span>
                </div>
            </div>
                ...
                <div class="form-group">
                    <label>
                        <input type="checkbox" name="is_lot_controlled" value="1" 
                               <?php echo (isset($_POST['is_lot_controlled']) || !isset($_POST['product_code'])) ? 'checked' : ''; ?>>
                        Lot Controlled
                    </label>
                ...
                <div class="form-group">
                    <label>
                        <input type="checkbox" name="is_active" value="1" 
                               <?php echo (isset($_POST['is_active']) || !isset($_POST['product_code'])) ? 'checked' : ''; ?>>
                        Active
                    </label>
